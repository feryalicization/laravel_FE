...
<body id="page-top">
    ...
    @include('sidebar-2')
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-5 mb-4">
                        <div class="card shadow" style="text-align: center;">
                            ...
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Jumlah Pegawai</h6>
                            </div>
                            <!-- Card Body -->
                            <div class="card-body">

                                <span style="font-size: 60px;"> {{$jumlahPegawai}} <i class="fas fa-user"></i></span> 
                    ...
                    <!-- Second Card: Another Card -->
                    <div class="col-xl-4 col-lg-5 mb-4">
                        <div class="card shadow" style="text-align: center;">
                            <!-- Card Header - Dropdown -->
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Pegawai Hadir</h6>
                            </div>
                            <!-- Card Body -->
                            <div class="card-body">

                                <span style="font-size: 60px;"> {{$jumlahAbsen}} <i class="fas fa-user"></i></span> 
